...
class MainActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val tema1 = Producto("Manejo de ListView",R.drawable.ilv,"Un ListView es un componente de vista de lista que nos servirá para mostrar datos, tal como puede ser una lista de contactos, lista de productos, etc.",R.drawable.ejemp)
        val tema2 = Producto("Manejo de Activities",R.drawable.activity,"Una Activity es un componente de la aplicación que contiene una pantalla con la que los usuarios pueden interactuar para realizar una acción, como marcar" +
                " un número telefónico, tomar una foto, enviar un correo electrónico o ver un mapa.",R.drawable.daniel )
        ...
        val tema4 = Producto("Controles de Audio",R.drawable.dio,"Para implementar audio a tu App existen diferentes formas.\n" +
    ...
    override fun onOptionsItemSelected(item: MenuItem): Boolean {
        ...
        when (item.itemId) {
            R.id.itmAcerca -> {
                ...
                "Elaborado por Daniel Mendez Fernandez.\n"+"GDS0142"
            }
            R.id.itmObjetivo -> {
